    ...
    public class TerrainPainterInspector : Editor
    {
        ...
        private void DrawLayers()
        {
            ...
            using (new EditorGUILayout.HorizontalScope(EditorStyles.toolbar))
            {
                ...
                {
                    heatmapEnabled = GUILayout.Toggle(heatmapEnabled, new GUIContent("  Heatmap", EditorGUIUtility.IconContent(iconPrefix + "console.warnicon").image), EditorStyles.toolbarButton, GUILayout.MaxWidth(110f));
                    if (heatmapEnabled)
                    {
